...
class HelpScreen(ModalScreen):
    header_text = """
        Welcome to dragonfruit! This screen contains a small subset of the online
        docs, available at https://dragonfruit.vercel.app/docs/getting-started
    """.split()
    ...
    def on_mount(self) -> None:
        ...
        container.border_title = "dragonfruit Help"
