...
def _version_option() -> str:
    ...
    """
    try:
        harlequin_version = version("dragonfruit_tui")
    except PackageNotFoundError:
        harlequin_version = "dev"
...
def build_cli() -> click.Command:
    ...
    @click.command()
    @click.version_option(package_name="dragonfruit_tui", message=_version_option())
    ...
    for adapter_name, adapter_cls in sorted(adapters.items()):
        ...
        click.rich_click.OPTION_GROUPS["dragonfruit_tui"].append(
